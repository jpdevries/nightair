...
},{"../helpers/notify.es6":10,"../model/nightairmodel.es6":13,"./pieces/digit.jsx":2,"./pieces/separator.jsx":5}],2:[function(require,module,exports){
"use strict";
...
},{"../../model/nightairmodel.es6":13}],4:[function(require,module,exports){
'use strict';
...
},{"../../model/nightairmodel.es6":13}],5:[function(require,module,exports){
"use strict";
...
},{"../../model/nightairmodel.es6":13,"./statusicon.jsx":7}],7:[function(require,module,exports){
"use strict";
...
},{"../../model/nightairmodel.es6":13,"./weekday.jsx":8}],10:[function(require,module,exports){
"use strict";
...
},{"../model/nightairmodel.es6":13}],11:[function(require,module,exports){
'use strict';
...
},{"../model/nightairmodel.es6":13}],12:[function(require,module,exports){
'use strict';
...
var Notify = require('./helpers/notify.es6'),
    // used to send notifications to the browser (beep beep)
inputControllers = require('./input/controllers.es6'),
    // keyboard event listeners. todo: refactor?
Clock = require('./clock/clock.jsx'),
    // the Clock component displays the digital digits and decides if the alarm should be dispatched
Meridian = require('./clock/pieces/meridian.jsx'),
    // displays AM/PM when militaryTime is disabled
Player = require('./clock/pieces/player.jsx'),
    // React component that plays alarm when alarm goes off
StatusBar = require('./clock/pieces/statusbar.jsx'),
    // status bar of icons such as alarm enabled (bell) and snooze icon
...
function step(timestamp) {
  // tick tock
  ReactDOM.render(React.createElement(Clock, null), digitsDOM);
...
},{"./clock/clock.jsx":1,"./clock/pieces/meridian.jsx":3,"./clock/pieces/player.jsx":4,"./clock/pieces/statusbar.jsx":6,"./clock/pieces/weekdays.jsx":9,"./helpers/notify.es6":10,"./input/controllers.es6":11,"./model/nightairmodel.es6":13}],13:[function(require,module,exports){
'use strict';
